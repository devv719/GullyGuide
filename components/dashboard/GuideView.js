    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-2">
         ...
         <div className="flex gap-4">
           <div className="flex items-center gap-4 bg-white dark:bg-zinc-900 px-6 py-4 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
             <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center border border-primary/20">
                 <span className="text-xl font-black text-primary">{assignedTrips.length}</span>
             </div>
             <div>
      ...
      <div className="grid lg:grid-cols-3 gap-8 mt-6">
        ...
        <div className="lg:col-span-2 space-y-6">
           ...
           <div className="space-y-4">
             {loading ? (
               <div className="w-full h-32 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl animate-pulse" />
             ) : assignedTrips.length === 0 ? (
               <div className="bg-white dark:bg-zinc-900 p-12 rounded-xl border border-zinc-200 dark:border-zinc-800 text-center flex flex-col items-center justify-center min-h-[250px] shadow-sm">
               ...
               assignedTrips.map(trip => (
                 <motion.div whileHover={{ y: -2 }} key={trip.id} className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-md hover:border-primary/50 transition-all group flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="space-y-6">
           <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex items-start gap-4 transition-colors">
           ...
           <div className="bg-primary/5 p-6 rounded-xl border border-primary/20">
              <h4 className="font-bold text-primary text-sm mb-3">Tips for Guides</h4>
              <ul className="text-sm text-zinc-700 dark:text-zinc-400 space-y-3 font-medium">
